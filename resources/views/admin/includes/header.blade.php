<div class="header">
    ...
    <div class="header-left" style="background-color: white">
        <a href="{{ route('adminDashboard') }}" class="logo">
            <img src="{{ asset('public/uploads/settings/'.$general->logo) }}" width="150" height="40" alt="">
        </a>
    </div>
    <!-- /Logo -->
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="index.html#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img"><img src="{{ asset('public/uploads/'.$current_user->image) }}" alt="">
