        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="{{ route('client.index') }}" class="btn add-btn"><i class="fa fa-eye"></i> View All Leads</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select class="select form-control department" name="source_id[]" id="source_id" multiple>
                                        ...
                                        <div class="form-group">
                                            <label for="source">Added By</label>
                                            <div class="input-group">
